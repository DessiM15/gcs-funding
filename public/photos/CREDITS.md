...
All images sourced from Unsplash under the Unsplash License, which permits free
commercial use without attribution. Credits recorded here as good practice and
so any image can be traced or replaced.
...
Replace any of these with Scott's own project photography by dropping a file of
the same name into this directory. Paths are referenced once, in src/lib/photos.ts.
